...
- 【新增】官网配 AI 生成插画共 12 张（text_to_image 接口，统一扁平卡通风 + 深蓝底 + 紫青配色）：Hero 小星球吉祥物（浮动动画 + 光晕）、3 张场景卡片插画（决策/头脑风暴/自我觉察，替换原 SVG 图标）、8 个人格卡通头像（狐狸评论家/猫头鹰分析师/太阳乐天派/小恶魔/喇叭用户/西装猫老板/脑洞创意/水豚总结者，替换原色点）

## 2026-09-05

### 2026-09-05 17:33 更新

- 【新增】对话消息超链接可点击：AI 消息（Markdown 渲染）与用户消息（纯文本气泡）中的 URL 均转为链接；统一外链出口 openExternal（桌面端经 tauri-plugin-opener 唤起系统浏览器，网页端新标签打开）；协议白名单仅 http/https，拦截 javascript: 等危险协议

## 2026-09-05

### 2026-09-05 17:33 更新

- 【新增】官网发布至 GitHub Pages：gh-pages 分支（根目录仅 index.html）+ 仓库 Settings 开启 Pages，线上地址 https://glancers.github.io/MindVerse/（已验证 200）

## 2026-09-05

### 2026-09-05 17:27 更新

- 【新增】site/index.html 项目官网单页：深色宇宙风（星点背景 + 渐变标题），含 Hero、三大场景、核心特性、预设人格展示、三形态快速开始、技术栈、GitHub 入口；纯内联 CSS 零依赖，字号偏小密度适中
